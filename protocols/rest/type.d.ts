...
export type RestHeaders = Headers | Record<string, string | number | boolean> | ReadonlyArray<readonly [string, string]>;
/**
 ...
 */
export type RestServerHandler = (request: RestServerInput, ctx: ServerRequestContext) => RestServerResponse | Promise<RestServerResponse>;
/**
...
export interface RestClientMethods {
    ...
    get<T = unknown>(url: string, options?: RestRequestOptions, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    post<T = unknown>(url: string, body?: unknown, options?: Omit<RestRequestOptions, "body">, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    put<T = unknown>(url: string, body?: unknown, options?: Omit<RestRequestOptions, "body">, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    patch<T = unknown>(url: string, body?: unknown, options?: Omit<RestRequestOptions, "body">, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    delete<T = unknown>(url: string, options?: RestRequestOptions, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    head<T = unknown>(url: string, options?: RestRequestOptions, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    options<T = unknown>(url: string, options?: RestRequestOptions, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    query<T = unknown>(url: string, body?: unknown, options?: Omit<RestRequestOptions, "body">, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    request<T = unknown>(method: HttpMethod | (string & {}), url: string, options?: RestRequestOptions, signal?: AbortSignal): Promise<UniversalResponse<T>>;
    stream<T = unknown>(url: string, options?: Omit<RestRequestOptions, "stream">, signal?: AbortSignal): Promise<UniversalResponse<T>>;
}
